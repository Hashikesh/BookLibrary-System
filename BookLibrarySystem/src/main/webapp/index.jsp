			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse justify-content-center"
					...
					<div
						...
						<div class="nav-item">
							<a href="LibrarianLogin.jsp" class="px-3 py-10"><i class="bi bi-door-open"></i> Librarian Login</a>
						</div>
						<div class="nav-item">
							<a href="login.jsp" class="px-3 py-10"><i class="bi bi-box-arrow-in-right"></i> Student Login</a>
						</div>
						<div class="nav-item">
							<a href="ContectUs.jsp" class="px-3 py-10"><i class="bi bi-person-lines-fill"></i> Contact Us</a>
						</div>
					</div>
				</div>
			</div>
